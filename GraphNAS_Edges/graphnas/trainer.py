...
from graphnas_variants.macro_graphnas.pyg.pyg_gnn_model_manager import GeoOGBManager
...
class Trainer(object):
    ...
    def build_model(self):
        ...
        if self.args.search_mode == "macro":
            ...
            if self.args.dataset in ['ogb']:
                self.submodel_manager = GeoOGBManager(self.args)
